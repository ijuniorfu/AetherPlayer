...
/// One third-party component shown on the licenses screen. License texts
/// ship as bundle resources and stay English (legal texts are not translated).
...
enum OpenSourceLicenses {
    ...
    static let components: [OpenSourceComponent] = {
        ...
        list.append(OpenSourceComponent(
            name: "Sparkle",
            licenseName: "MIT (with bundled component licenses)",
            url: "https://github.com/sparkle-project/Sparkle",
            notice: nil,
            textResource: "LicenseText-Sparkle"
        ))
#endif
        return list
    }()
