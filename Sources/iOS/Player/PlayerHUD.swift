...
/// Transient HUD for brightness/volume swipes and skip ripples. Reads a hud kind + 0...1 level and is
/// shown/auto-faded by the chrome (opacity gated on the view model's hudKind).
    ...
    var body: some View {
        VStack(spacing: 8) {
            Image(systemName: icon)
                ...
                // Swap the glyph instantly instead of cross-morphing it: the chrome fades in via opacity,
